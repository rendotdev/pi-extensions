...
import { REVIEW_RETENTION_MILLISECONDS, ReviewRetentionPolicyClass } from "./review-retention.ts";

describe("ReviewRetentionPolicyClass", () => {
  it("creates a hard seven-day expiration", () => {
    const Policy = new ReviewRetentionPolicyClass(
