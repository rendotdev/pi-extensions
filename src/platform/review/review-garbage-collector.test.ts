...
describe("ReviewGarbageCollectorClass", () => {
  it("removes expired reviews, including open reviews, and preserves fresh reviews", async () => {
    ...
    const Collector = new ReviewGarbageCollectorClass(
      {},
      {
        retentionPolicy: new ReviewRetentionPolicyClass(
